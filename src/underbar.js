(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(first, next){
      return first = iterator(next) ? first : false;
    }, true)
  };
  ...
  _.extend = function(obj) {
    _.each([].slice.call(arguments, 1), function(object) {
